    ...
    return (
        <div className="md:flex gap-10">
            ...
            <div className='md:w-2/3'>
                ...
                <button type='button' className='bg-indigo-600 hover:bg-indigo-800 px-5 py-2 mt-5 text-white font-bold uppercase rounder' onClick={()=>handleSetPedido({...producto,cantidad})}> {edicion ? 'Guardar Cambios':'Añadir Pedido' }</button>
            </div>
